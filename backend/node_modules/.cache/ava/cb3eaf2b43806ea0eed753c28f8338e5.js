...
(0, _ava2.default)('Create a new applicant', async t => {
    ...
    t.is(res.status, 200);
    t.is(res.body.name, applicantToCreate.name);
    t.is(res.body.surname, applicantToCreate.surname);
    t.is(res.body.location, applicantToCreate.location);
    t.is(res.body.interests, applicantToCreate.interests);
    t.is(res.body.applications, applicantToCreate.applications);
});
//# sourceMappingURL=/Users/elenavolovicheva/Documents/Study/JS/2018-js-crash-course/node_modules/.cache/ava/cb3eaf2b43806ea0eed753c28f8338e5.js.map